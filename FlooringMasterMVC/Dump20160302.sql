CREATE DATABASE  IF NOT EXISTS `flooring` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `flooring`;
-- MySQL dump 10.13  Distrib 5.5.47, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: flooring
-- ------------------------------------------------------
...
CREATE TABLE `product` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(130) NOT NULL,
  `labor_cost_rate` decimal(20,0) NOT NULL,
  `material_cost_rate` decimal(20,0) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-03-02 11:07:44
